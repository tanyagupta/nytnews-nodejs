...
const HELP_MESSAGE = 'You can say tell me New York Times news, or, you can say stop... What can I help you with?';
const HELP_REPROMPT = 'What can I help you with?';
const FALLBACK_MESSAGE = 'The New York Times News skill can\'t help you with that.  It can help you discover hot new News if you say tell me a New York Times news. What can I help you with?';
const FALLBACK_REPROMPT = 'What can I help you with?';
const STOP_MESSAGE = 'Goodbye!';
const ANOTHER_FACT = 'Would you like another news headline?';
const LAST_FACT = "You have now finished hearing about all the news for today";
  ...
  canHandle(handlerInput) {
    const request = handlerInput.requestEnvelope.request;
      ...
      async handle(handlerInput) {
        ...
        const news_name = ALL_FACTS[factIndex][0];
        ...
        var response_string = "A current news is "+news_name+", reviewed by "+reviewer_name+". Here's a snippet of the review: "+review_snippet;
        var response_clean = response_string.replace(/\&/ig, 'and')
        sessionAttributes.lastSpeech = response_clean;

        var MSG = response_clean+" Would you like to hear another news review?"
...
const RepeatHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder
      .speak(REPEAT+" Would you like another news?")
      .reprompt(REPEAT+" Would you like another news?")
      .getResponse();
  },
};
